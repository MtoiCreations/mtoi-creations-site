...
export default function EditProduitPage() {
  ...
  const loadProduit = async (token: string) => {
    try {
      ...
      if (res.ok) {
        ...
        if (produit) {
          setForm({
            ...
            quantiteDisponible: produit.quantite_disponible.toString(),
            surCommande: produit.sur_commande,
            delaisFabrication: produit.delais_fabrication || "",
